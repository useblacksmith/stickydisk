...
async function commitStickydisk(exposeId: string, stickyDiskKey: string): Promise<void> {
...
async function cleanupStickyDiskWithoutCommit(exposeId: string, stickyDiskKey: string): Promise<void> {
